<div class="d-flex w-100 justify-content-center">
    <div class="d-flex flex-column align-items-center justify-content-center body-setup">
        ...
        <p class="body-para">
            ...
            trouver un travail qui vous convient !<br>
            Inscrivez-vous à nos formations et projets,<br>
            et commencez dès maintenant.
        </p>
        <div>
            <button class="btn body-button">Chercher Formations</button>
            <button class="btn body-button">Chercher Projets</button>
        </div>
    </div>
</div>